...
class Stringalong {
  ...
  _pickWeighted(items, rng) {
    // Deck-of-cards model: {90%} means this item occupies 90% of the deck.
    // Untagged items (chance === 1) split whatever remains equally.
    ...
    // Weight for each untagged item: split the remainder equally
  ...
  _pickFromList(list, ctx, unique) {
    ...
    return this._pickWeighted(items, ctx.rng);
  }
